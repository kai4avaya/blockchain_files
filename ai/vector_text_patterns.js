...
// import { adjustCameraToFitScene, clearScenesAndHideObjects } from '../ui/graph_v2/reorientScene.js';
...
//     try {
//         // Clear existing scene and hide objects
//         clearScenesAndHideObjects();

//         // Fetch data using your memory worker
...
//         // Create a map for quick lookup of vector data
...
//         // Create a mapping of key to UMAP coordinates
//         const keyToCoords = {};
...
//                         keyToCoords[key][0] * 100,
//                         keyToCoords[key][1] * 100,
//                         keyToCoords[key][2] * 100
//                     );
...
//                     scene.add(textPlane);
//                     console.log(`Added text plane for key: ${key}, fileId: ${vectorData.fileId}`);
//                 } else {
//                     console.warn('Missing data for key:', key);
//                 }
//             });

//             // Calculate center position for the bucket
//             centerPosition.divideScalar(bucketObjects.length);

//             // Create visual connections within the bucket
//             for (let i = 0; i < bucketObjects.length - 1; i++) {
//                 for (let j = i + 1; j < bucketObjects.length; j++) {
//                     const obj1 = scene.getObjectByProperty('userData', { key: String(bucketObjects[i] - 1) });
//                     const obj2 = scene.getObjectByProperty('userData', { key: String(bucketObjects[j] - 1) });
//                     if (obj1 && obj2) {
...
//         // Adjust text plane orientations
//         adjustTextPlaneOrientations();

//         // Send the updated scene bounding box to the worker
