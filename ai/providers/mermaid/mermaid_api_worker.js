...
async function generateAndSaveMermaidDiagram(description, skipSave = false) {
    try {
        ...
        try {
            ...
            // Create proper base64 encoding with SVG MIME type
            ...
            // Only save to IndexDB if skipSave is false
            if (!skipSave) {
