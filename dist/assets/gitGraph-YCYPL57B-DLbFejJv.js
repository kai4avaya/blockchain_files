import { _ as __vitePreload } from './worker-CBGrwT8c.js';
import { bY as createAssigner, bZ as isPrototype, bc as isArrayLike, bH as copyObject, bg as assignValue, bd as isArray, aR as baseRest, aS as isArrayLikeObject, bx as baseAssignValue, bA as isObjectLike, bB as baseGetTag, bM as nodeUtil, by as baseUnary, aU as isFunction, aV as isEmpty, be as identity, b8 as isObject } from './index-CZEwXjve.js';
import { k as keys, j as baseEach, g as baseIteratee, S as SetCache, w as arrayIncludes, x as cacheHas, c as baseFlatten, v as values, y as baseIndexOf, l as arrayMap, z as getAllKeysIn, A as arrayFilter, B as baseFilter, C as arraySome, a as baseUniq, d as forEach, i as isUndefined, r as reduce, f as filter, D as noop } from './_baseUniq-CzFjMu3V.js';
import { j as toInteger, m as map, d as basePickBy, f as flatten, g as find, i as defaults, h as has, l as last, e as min } from './_basePickBy-FSR6Gnrr.js';
import { c as clone } from './clone-D905m58X.js';
...
function isGroup(item) {
    return reflection$1.isInstance(item, Group);
}
...
class DefaultScopeComputation {
    ...
    async computeExports(document, cancelToken = CancellationToken_1.None) {
     ...
     */
    async computeExportsForNode(parentNode, document, children = streamContents, cancelToken = CancellationToken_1.None) {
        const exports = [];
    ...
    async computeLocalScopes(document, cancelToken = CancellationToken_1.None) {
...
class DefaultDocumentBuilder {
    ...
    waitUntil(state, uriOrToken, cancelToken) {
        ...
        cancelToken !== null && cancelToken !== void 0 ? cancelToken : (cancelToken = CancellationToken_1.None);
        if (uri) {
...
class DefaultWorkspaceLock {
    ...
    write(action) {
        this.cancelWrite();
        const tokenSource = new CancellationTokenSource_1();
    ...
    enqueue(queue, action, cancellationToken) {
        ...
        const entry = {
            action,
            deferred,
            cancellationToken: cancellationToken !== null && cancellationToken !== void 0 ? cancellationToken : CancellationToken_1.None
        };
        queue.push(entry);
...
var initializers = {
  info: /* @__PURE__ */ __name(async () => {
    const { createInfoServices: createInfoServices2 } = await __vitePreload(async () => { const { createInfoServices: createInfoServices2 } = await Promise.resolve().then(() => info46DW6VJ7);return { createInfoServices: createInfoServices2 }},true?void 0:void 0);
    const parser = createInfoServices2().Info.parser.LangiumParser;
    parsers.info = parser;
  }, "info"),
  packet: /* @__PURE__ */ __name(async () => {
    const { createPacketServices: createPacketServices2 } = await __vitePreload(async () => { const { createPacketServices: createPacketServices2 } = await Promise.resolve().then(() => packetW2GHVCYJ);return { createPacketServices: createPacketServices2 }},true?void 0:void 0);
    const parser = createPacketServices2().Packet.parser.LangiumParser;
    parsers.packet = parser;
  }, "packet"),
  pie: /* @__PURE__ */ __name(async () => {
    const { createPieServices: createPieServices2 } = await __vitePreload(async () => { const { createPieServices: createPieServices2 } = await Promise.resolve().then(() => pieBEWT4RHE);return { createPieServices: createPieServices2 }},true?void 0:void 0);
    const parser = createPieServices2().Pie.parser.LangiumParser;
    parsers.pie = parser;
  }, "pie"),
  architecture: /* @__PURE__ */ __name(async () => {
    const { createArchitectureServices: createArchitectureServices2 } = await __vitePreload(async () => { const { createArchitectureServices: createArchitectureServices2 } = await Promise.resolve().then(() => architectureI3QFYML2);return { createArchitectureServices: createArchitectureServices2 }},true?void 0:void 0);
    const parser = createArchitectureServices2().Architecture.parser.LangiumParser;
    parsers.architecture = parser;
  }, "architecture"),
  gitGraph: /* @__PURE__ */ __name(async () => {
    const { createGitGraphServices: createGitGraphServices2 } = await __vitePreload(async () => { const { createGitGraphServices: createGitGraphServices2 } = await Promise.resolve().then(() => gitGraphYCYPL57B);return { createGitGraphServices: createGitGraphServices2 }},true?void 0:void 0);
...
const info46DW6VJ7 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  InfoModule,
  createInfoServices
}, Symbol.toStringTag, { value: 'Module' }));

const packetW2GHVCYJ = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  PacketModule,
  createPacketServices
}, Symbol.toStringTag, { value: 'Module' }));

const pieBEWT4RHE = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  PieModule,
  createPieServices
}, Symbol.toStringTag, { value: 'Module' }));

const architectureI3QFYML2 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  ArchitectureModule,
  createArchitectureServices
}, Symbol.toStringTag, { value: 'Module' }));

const gitGraphYCYPL57B = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  GitGraphModule,
