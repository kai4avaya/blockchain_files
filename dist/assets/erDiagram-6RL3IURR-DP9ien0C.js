import { _ as __name, y as getConfig2, u as setAccTitle, v as getAccTitle, x as setAccDescription, w as getAccDescription, N as setDiagramTitle, O as getDiagramTitle, G as log, T as clear, F as select, S as utils_default, H as configureSvgSize, am as line, at as curveBasis, as as parseGenericTypes } from './index-CZEwXjve.js';
import { G as Graph } from './graph-EgkHFYLR.js';
import { l as layout } from './layout-CvRHAWPj.js';
...
var drawEntities = /* @__PURE__ */ __name(function(svgNode, entities2, graph) {
  ...
  keys.forEach(function(entityName) {
    ...
    const textNode = groupNode.append("text").classed("er entityLabel", true).attr("id", textId).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "middle").style("font-family", getConfig2().fontFamily).style("font-size", conf.fontSize + "px").text(entities2.get(entityName).alias ?? entityName);
...
var drawRelationshipFromLayout = /* @__PURE__ */ __name(function(svg, rel, g, insert, diagObj) {
  ...
  const labelNode = svg.append("text").classed("er relationshipLabel", true).attr("id", labelId).attr("x", labelPoint.x).attr("y", labelPoint.y).style("text-anchor", "middle").style("dominant-baseline", "middle").style("font-family", getConfig2().fontFamily).style("font-size", conf.fontSize + "px");
