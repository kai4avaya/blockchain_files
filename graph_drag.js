...
//   trailGeometry.setDrawRange(0, Math.min(trailIndex, MAX_TRAIL_LENGTH));
...
//   const { camera, nonBloomScene, raycaster } = share3dDat();

//   raycaster.setFromCamera({ x, y }, camera);

//   // Create a plane that spans the entire view
//   const planeNormal = new THREE.Vector3(0, 0, 1);
//   const planeConstant = -camera.position.z;
//   const plane = new THREE.Plane(planeNormal, planeConstant);

//   // Intersect with this plane instead of scene objects
//   const intersectionPoint = new THREE.Vector3();
//   raycaster.ray.intersectPlane(plane, intersectionPoint);

//   trailPositions[trailIndex * 3] = intersectionPoint.x;
//   trailPositions[trailIndex * 3 + 1] = intersectionPoint.y;
//   trailPositions[trailIndex * 3 + 2] = intersectionPoint.z;

//   const color = new THREE.Color(0xff0000);
//   assignColor(trailColors, trailIndex, color);

//   console.log(`Adding point at index ${trailIndex}: (${intersectionPoint.x}, ${intersectionPoint.y}, ${intersectionPoint.z})`);
